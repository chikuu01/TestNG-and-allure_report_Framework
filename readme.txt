These project is created to generating the report which shows us the test how many test cases are passes , failed and skipped And shows the status of the project by using TestNG framework.
